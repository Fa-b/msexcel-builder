...
(function() {
  var ContentTypes, DocPropsApp, JSDateToExcel, JSZip, SharedStrings, Sheet, CalcChain, Style, Workbook, XlRels, XlWorkbook, baseXl, fs, tool, xml,
  ...
  Sheet = (function() {
    ...
    Sheet.prototype.formula = function(col, row, str) {
      if (typeof str === 'string') {
        ...
        let sheet_idx = this.book.sheets.findIndex(sheet => sheet.name === this.name);
  ...
  CalcChain = (function() {
    ...
    CalcChain.prototype.add_ref = function(idx, col, row) {
        ...
        this.cache[num].push(tool.i2a(col) + row);
    };
      
    CalcChain.prototype.toxml = function() {
      var cc, cells, l, len, key, ref;
